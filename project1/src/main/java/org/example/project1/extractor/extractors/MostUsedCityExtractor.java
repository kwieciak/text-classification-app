...
public class MostUsedCityExtractor implements Extractor<String> {
    ...
    public MostUsedCityExtractor(WordCounterBuffer wordCounterBuffer) {
        this.wordCounterBuffer = wordCounterBuffer;
    }
    @Override
    public String extract(Article article) {
        String text = wordCounterBuffer.getText(article);
        return extractStringFeature(text, "project1/src/main/resources/org/example/project1/extractors/cities.csv");
    }
}