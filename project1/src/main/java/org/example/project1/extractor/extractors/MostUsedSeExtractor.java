...
public class MostUsedSeExtractor implements Extractor<String> {
    ...
    public MostUsedSeExtractor(WordCounterBuffer wordCounterBuffer) {
        this.wordCounterBuffer = wordCounterBuffer;
    }
    @Override
    public String extract(Article article) {
        String text = wordCounterBuffer.getText(article);
        return extractStringFeature(text, "project1/src/main/resources/org/example/project1/extractors/se.csv");
    }
}